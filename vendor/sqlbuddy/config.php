...
$sbconfig['DefaultAdapter'] = $CFG->dbtype;
$sbconfig['DefaultHost'] = $CFG->dbhost;
$sbconfig['DefaultUser'] = $CFG->dbuser;
$sbconfig['DefaultPass'] = $CFG->dbpass;
$sbconfig['DefaultDatabase'] = $CFG->dbname;
